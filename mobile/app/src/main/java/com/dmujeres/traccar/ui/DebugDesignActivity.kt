        ...
        setContent {
            DmujeresTheme {
                DebugDesignContent(
                    ...
                    onActivationGuide = { startActivity(Intent(this, ActivationGuideActivity::class.java)) },
                    onOnboarding = { step ->
                        startActivity(
    ...
    private fun DebugDesignContent(
        ...
        Column(
            ...
            var wakeLockEnabled by remember {
                mutableStateOf(AppConfig(context).wakeLockExperimentEnabled)
            }
            Column(
                modifier = Modifier
                    .fillMaxSize()
                ...
                DebugButton(
                    text = stringResource(
                        if (wakeLockEnabled) R.string.debug_wakelock_on else R.string.debug_wakelock_off,
                    ),
                ) {
                    wakeLockEnabled = !wakeLockEnabled
                    AppConfig(context).wakeLockExperimentEnabled = wakeLockEnabled
                }
                DebugButton(stringResource(R.string.debug_splash), onSplash)
                DebugButton(stringResource(R.string.debug_activation_guide), onActivationGuide)
